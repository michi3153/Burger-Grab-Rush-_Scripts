...
public class ToBurgerMenu : MonoBehaviour
{
    AudioSource audioSource;
    public List<AudioClip> confirmClip = new List<AudioClip>();
    public string sceneName = "BurgerMenu";
    ...
    void Start()
    {
        ...
        {
            ingredientButton.onClick.AddListener(SelectedToBurger);
        }
        else
        {
